...
│
└── 🖼️ Images/                    # Разделенные по папкам изображения
...
## 🖼️ Работа с изображениями в облаке

### 📁 Доступ к изображениям
**Прямая ссылка:** https://cloud.utair.ru/apps/files/files/3350055?dir=/TST_project/Images

### 🗂️ Организация папок
Каждая папка содержит 30 кадров, извлеченных из соответствующего видео:
- **Название папки** = название исходного видео (без расширения)
- **Содержимое:** frame_001.jpg, frame_002.jpg, ..., frame_030.jpg
- **Формат:** JPG, оптимизированный для анализа

### 🔍 Просмотр и анализ
1. **Через веб-интерфейс:** https://cloud.utair.ru/apps/files/files/3350055?dir=/TST_project/Images
2. **Скачивание папки:** для локального анализа
3. **Прямая ссылка:** для интеграции с другими системами

### 📊 Статистика изображений
- **Всего папок:** 8 (по количеству исходных видео)
- **Общее количество кадров:** 8 × 30 = 240 изображений
- **Формат:** JPG, оптимизированный размер
- **Организация:** по зонам и времени съемки
...
│   ├── Моечная/
│   └── Склад/
├── Images/                    # Извлеченные кадры (по папкам)
│   ├── 1 секция_ задняя правая_20250723_101500/
│   ├── 1 секция_ задняя средняя_20250723_101500/
│   ├── Моечная средняя_2_20250723_101500/
│   └── Склад_ зона самовыдачи-1_20250527_105059/
...
**🌐 Ваше облако:** 
- **Videos:** https://cloud.utair.ru/apps/files/?dir=/TST_project/Videos
- **Images:** https://cloud.utair.ru/apps/files/files/3350055?dir=/TST_project/Images

**📁 Локальные ссылки:** 
- `Videos/` → облако (видео)
- `Images/` → облако (изображения)
